<script setup>
const pokemon = defineProps(["name", "xp","urlBaseSvg"])
</script>
...
.cardListPokemon {
    ...
    background: radial-gradient(circle, rgba(234, 234, 242, 0.8211659663865546) 9%, rgba(39, 141, 251, 0.8799894957983193) 51%, rgba(67, 116, 222, 0.8883928571428571) 94%);
    cursor: pointer;
}
